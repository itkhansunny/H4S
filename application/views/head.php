 ...
 * Author: Khan Sunny
 * -----
 * Last Modified: 03 07 2019, 6:42:13 PM
...
<div class="header hide-mobile">
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-between">
			<div>
				<div class="hamburger sidebar-toggle d-lg-none">
					<span class="line"></span>
					<span class="line"></span>
					<span class="line"></span>
				</div>
			</div>
			<div class="m-t-7 d-lg-none h3 text-center">Hands For Society</div>
			<div>
				<div class="dropdown dib hide-sm">
									...
									<li>
										<a href="#">
											<img class="pull-left m-r-10 avatar-img"
												src="<?php echo base_url('assets/images/avatar/3.jpg');?>" alt="" />

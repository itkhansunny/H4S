...
/*
 * File: author_update.php
 * Created Date: 03 07 2019, 1:30:28 AM
 * Author: Khan Sunny
 * -----
 * Last Modified: 03 07 2019, 1:53:02 AM
		...
		<div class="card">
			...
			<?php if(isset($msg_success)) { echo msg_success($msg_success); } ?>
				<div class="form-validation">
					<?php if(is_array($authorData)):foreach ($authorData as $data):?>
					<?php echo form_open_multipart('library/updateAuthorStore/'.$data->id, 'class="form-valide"'); ?>
